...
@XmlType(name = "REDUCCIONES", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA", propOrder = {
    "reduccion"
})
public class REDUCCIONES {
    ...
    public static class REDUCCION {
        ...
        @XmlElement(name = "CODTIPOREDUCCION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String codtiporeduccion;
        @XmlElement(name = "DESTIPOREDUCCION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
