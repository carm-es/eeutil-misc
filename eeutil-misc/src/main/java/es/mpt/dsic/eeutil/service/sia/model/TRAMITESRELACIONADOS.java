...
@XmlType(name = "TRAMITESRELACIONADOS", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA", propOrder = {
    "tramiterelacionado"
})
public class TRAMITESRELACIONADOS {
    ...
    public static class TRAMITERELACIONADO {
        ...
        @XmlElement(name = "TRCODACTUACION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String trcodactuacion;
        @XmlElement(name = "TRORDEN", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
