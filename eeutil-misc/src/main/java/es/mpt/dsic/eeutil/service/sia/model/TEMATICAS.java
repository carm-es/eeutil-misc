...
@XmlType(name = "TEMATICAS", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA", propOrder = {
    "tematica"
})
public class TEMATICAS {
    ...
    public static class TEMATICA {
        ...
        @XmlElement(name = "CODTEMATICA", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String codtematica;
        @XmlElement(name = "DESMATERIA", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
