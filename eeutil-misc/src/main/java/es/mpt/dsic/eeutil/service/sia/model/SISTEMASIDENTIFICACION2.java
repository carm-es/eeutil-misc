...
public class SISTEMASIDENTIFICACION2 {

    @XmlElement(name = "SISTEMAIDENTIFICACION")
    protected List<SISTEMASIDENTIFICACION2 .SISTEMAIDENTIFICACION> sistemaidentificacion;
     ...
     * {@link SISTEMASIDENTIFICACION2 .SISTEMAIDENTIFICACION }
     * 
     * 
     */
    public List<SISTEMASIDENTIFICACION2 .SISTEMAIDENTIFICACION> getSISTEMAIDENTIFICACION() {
        if (sistemaidentificacion == null) {
            sistemaidentificacion = new ArrayList<SISTEMASIDENTIFICACION2 .SISTEMAIDENTIFICACION>();
        }
