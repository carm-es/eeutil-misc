...
public class VOLUMENESTRAMITACIONES2 {

    @XmlElement(name = "VOLUMENTRAMITACION")
    protected List<VOLUMENESTRAMITACIONES2 .VOLUMENTRAMITACION> volumentramitacion;
     ...
     * {@link VOLUMENESTRAMITACIONES2 .VOLUMENTRAMITACION }
     * 
     * 
     */
    public List<VOLUMENESTRAMITACIONES2 .VOLUMENTRAMITACION> getVOLUMENTRAMITACION() {
        if (volumentramitacion == null) {
            volumentramitacion = new ArrayList<VOLUMENESTRAMITACIONES2 .VOLUMENTRAMITACION>();
        }
