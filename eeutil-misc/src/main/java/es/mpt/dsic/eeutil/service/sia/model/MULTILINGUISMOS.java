...
/**
 * <p>Clase Java para MULTILINGUISMOS complex type.
 * 
...
@XmlType(name = "MULTILINGUISMOS", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA", propOrder = {
    "multilinguismo"
})
public class MULTILINGUISMOS {
     ...
     * This is why there is not a <CODE>set</CODE> method for the multilinguismo property.
     * 
     * <p>
    ...
    public static class MULTILINGUISMO {
        ...
        @XmlElement(name = "IDIOMA", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String idioma;
        @XmlElement(name = "DESIDIOMA", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String desidioma;
        @XmlElement(name = "OTRO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String otro;
        @XmlElement(name = "TIPOCONTENIDO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
