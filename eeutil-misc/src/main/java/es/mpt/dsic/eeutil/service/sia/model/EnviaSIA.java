...
@XmlRootElement(name = "enviaSIA", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
public class EnviaSIA {

    @XmlElement(name = "ERROR", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
    protected EnviaSIA.ERROR error;
    @XmlElement(name = "ACTUACIONES", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
    ...
    public static class ACTUACIONES {
        ...
        @XmlElement(name = "ACTUACION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        ...
        public static class ACTUACION {
            ...
            @XmlElement(name = "CODIGOACTUACION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA", required = true)
            protected String codigoactuacion;
            @XmlElement(name = "TIPOTRAMITE", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA", required = true)
            protected TIPOTRAMITE tipotramite;
            @XmlElement(name = "INTERNO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String interno;
            @XmlElement(name = "COMUN", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String comun;
            @XmlElement(name = "DENOMINACION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String denominacion;
            @XmlElement(name = "FINALIDAD", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String finalidad;
            @XmlElement(name = "ORGANISMORESPONSABLE", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected ORGANISMORESPONSABLE organismoresponsable;
            @XmlElement(name = "DESTINATARIOS", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected DESTINATARIOS destinatarios;
            @XmlElement(name = "CODNIVELADMINISTRACIONELECTRONICA", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String codniveladministracionelectronica;
            @XmlElement(name = "DESNIVELADMINISTRACIONELECTRONICA", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String desniveladministracionelectronica;
            @XmlElement(name = "URL", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String url;
            @XmlElement(name = "TITULOCIUDADANO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String titulociudadano;
            @XmlElement(name = "DESCRIPCIONCIUDADANO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String descripcionciudadano;
            @XmlElement(name = "NIVELMAXIMOTRAMITACION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String nivelmaximotramitacion;
            @XmlElement(name = "SISTEMASIDENTIFICACION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected SISTEMASIDENTIFICACION sistemasidentificacion;
            @XmlElement(name = "IMPULSOADMINISTRACION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String impulsoadministracion;
            @XmlElement(name = "PUBLICACIONSEDE060", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String publicacionsede060;
            @XmlElement(name = "CODPORTAL", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String codportal;
            @XmlElement(name = "SEGSERVICIO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String segservicio;
            @XmlElement(name = "CODACTUACIONSEG", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String codactuacionseg;
            @XmlElement(name = "CODTIPOENCUESTA", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String codtipoencuesta;
            @XmlElement(name = "MULTILINGUISMOS", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected MULTILINGUISMOS multilinguismos;
            @XmlElement(name = "PRESTACIONES", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected PRESTACIONES prestaciones;
            @XmlElement(name = "VOLTRAMITACIONESACTUAL", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String voltramitacionesactual;
            @XmlElement(name = "VOLUMENESTRAMITACIONES", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected VOLUMENESTRAMITACIONES volumenestramitaciones;
            @XmlElement(name = "TEMATICAS", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected TEMATICAS tematicas;
            @XmlElement(name = "CODTIPOLOGIA", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String codtipologia;
            @XmlElement(name = "DESTIPOLOGIA", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String destipologia;
            @XmlElement(name = "PERFILES", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected PERFILES perfiles;
            @XmlElement(name = "TRAMITESRELACIONADOS", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected TRAMITESRELACIONADOS tramitesrelacionados;
            @XmlElement(name = "REQUISITOS", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String requisitos;
            @XmlElement(name = "PRESENTACIONPRESENCIAL", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String presentacionpresencial;
            @XmlElement(name = "LUGARPRESENTACION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected LUGARPRESENTACION lugarpresentacion;
            @XmlElement(name = "ORGANOINICIA", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String organoinicia;
            @XmlElement(name = "INICIOS", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected INICIOS inicios;
            @XmlElement(name = "PLAZORESOLUCION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected PLAZORESOLUCION plazoresolucion;
            @XmlElement(name = "FINVIA", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String finvia;
            @XmlElement(name = "NORMATIVAS", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected NORMATIVAS normativas;
            @XmlElement(name = "REDUCCIONES", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected REDUCCIONES reducciones;
            @XmlElement(name = "DOCUMENTACION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String documentacion;
            @XmlElement(name = "DOCUMENTOSCATALOGO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected DOCUMENTOSCATALOGO documentoscatalogo;
            @XmlElement(name = "CODESTADOACTUACION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String codestadoactuacion;
            @XmlElement(name = "DESESTADOACTUACION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
            protected String desestadoactuacion;
            @XmlElement(name = "FECHAULTIMAACTUALIZACION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
    ...
    public static class ERROR {
        ...
        @XmlElement(name = "DESCERROR", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA", required = true)
        protected String descerror;
        @XmlElement(name = "ERROR", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA", required = true)
