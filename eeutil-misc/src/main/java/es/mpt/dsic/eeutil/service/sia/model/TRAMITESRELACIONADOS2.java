...
/**
 * <p>
 * Clase Java para TRAMITESRELACIONADOS complex type.
 * 
 * <p>
...
@XmlType(name = "TRAMITESRELACIONADOS", propOrder = {"tramiterelacionado"})
public class TRAMITESRELACIONADOS2 {

  @XmlElement(name = "TRAMITERELACIONADO")
  protected List<TRAMITESRELACIONADOS2.TRAMITERELACIONADO> tramiterelacionado;
   ...
   * there is not a <CODE>set</CODE> method for the tramiterelacionado property.
   * 
   * <p>
   ...
   * {@link TRAMITESRELACIONADOS2 .TRAMITERELACIONADO }
   * 
   * 
   */
  public List<TRAMITESRELACIONADOS2.TRAMITERELACIONADO> getTRAMITERELACIONADO() {
    if (tramiterelacionado == null) {
      tramiterelacionado = new ArrayList<TRAMITESRELACIONADOS2.TRAMITERELACIONADO>();
    }
   ...
   */
  @XmlAccessorType(XmlAccessType.FIELD)
  @XmlType(name = "", propOrder = {"trcodactuacion", "trorden"})
