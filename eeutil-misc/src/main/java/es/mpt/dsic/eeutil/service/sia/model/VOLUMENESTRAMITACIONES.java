...
@XmlType(name = "VOLUMENESTRAMITACIONES", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA", propOrder = {
    "volumentramitacion"
})
public class VOLUMENESTRAMITACIONES {
     ...
     * This is why there is not a <CODE>set</CODE> method for the volumentramitacion property.
     * 
     * <p>
    ...
    public static class VOLUMENTRAMITACION {
        ...
        @XmlElement(name = "ANIO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String anio;
        @XmlElement(name = "PERIODO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String periodo;
        @XmlElement(name = "VOLTOTAL", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String voltotal;
        @XmlElement(name = "VOLELE", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String volele;
        @XmlElement(name = "VOLNOELE", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String volnoele;
        @XmlElement(name = "VOLCERTIFICADOELE", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String volcertificadoele;
        @XmlElement(name = "VOLDNIELE", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String voldniele;
        @XmlElement(name = "VOLELEOTRO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
