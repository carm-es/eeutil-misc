...
@XmlRootElement(name = "enviaSIA", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
public class EnviaSIA3 {

    @XmlElement(name = "ERROR", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
    protected EnviaSIA3 .ERROR error;
    @XmlElement(name = "ACTUACIONES", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
    protected EnviaSIA3 .ACTUACIONES actuaciones;
     ...
     * @return
     *     possible object is
     *     {@link EnviaSIA3 .ERROR }
     *     
     */
    public EnviaSIA3 .ERROR getERROR() {
        return error;
    }
     ...
     *     
     */
    public void setERROR(EnviaSIA3 .ERROR value) {
        this.error = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link EnviaSIA3 .ACTUACIONES }
     *     
     */
    public EnviaSIA3 .ACTUACIONES getACTUACIONES() {
        return actuaciones;
    }
     ...
     *     
     */
    public void setACTUACIONES(EnviaSIA3 .ACTUACIONES value) {
    ...
    public static class ACTUACIONES {
        ...
        @XmlElement(name = "ACTUACION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
        protected List<EnviaSIA3 .ACTUACIONES.ACTUACION> actuacion;
         ...
         * {@link EnviaSIA3 .ACTUACIONES.ACTUACION }
         * 
         * 
         */
        public List<EnviaSIA3 .ACTUACIONES.ACTUACION> getACTUACION() {
            if (actuacion == null) {
                actuacion = new ArrayList<EnviaSIA3 .ACTUACIONES.ACTUACION>();
            }
        ...
        public static class ACTUACION {
            ...
            @XmlElement(name = "CODIGOACTUACION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA", required = true)
            protected String codigoactuacion;
            @XmlElement(name = "TIPOSACTUACION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected EnviaSIA3 .ACTUACIONES.ACTUACION.TIPOSACTUACION tiposactuacion;
            @XmlElement(name = "DENOMINACION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected String denominacion;
            @XmlElement(name = "DESCRIPCION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected String descripcion;
            @XmlElement(name = "TITULOSERVICIO", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected String tituloservicio;
            @XmlElement(name = "DESCRIPCIONSERVICIO", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected String descripcionservicio;
            @XmlElement(name = "ORGANISMORESPONSABLE", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected EnviaSIA3 .ACTUACIONES.ACTUACION.ORGANISMORESPONSABLE organismoresponsable;
            @XmlElement(name = "AMBITOSGEOGRAFICOS", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected EnviaSIA3 .ACTUACIONES.ACTUACION.AMBITOSGEOGRAFICOS ambitosgeograficos;
            @XmlElement(name = "CODTIPOLOGIA", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected String codtipologia;
            @XmlElement(name = "DESTIPOLOGIA", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected String destipologia;
            @XmlElement(name = "AQUIENESVADIRIGIDO", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected EnviaSIA3 .ACTUACIONES.ACTUACION.AQUIENESVADIRIGIDO aquienesvadirigido;
            @XmlElement(name = "CODNIVELADMINISTRACIONELECTRONICA", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected String codniveladministracionelectronica;
            @XmlElement(name = "DESNIVELADMINISTRACIONELECTRONICA", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected String desniveladministracionelectronica;
            @XmlElement(name = "URL", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected String url;
            @XmlElement(name = "SISTEMASIDENTIFICACION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected EnviaSIA3 .ACTUACIONES.ACTUACION.SISTEMASIDENTIFICACION sistemasidentificacion;
            @XmlElement(name = "NIVELMAXIMOTRAMITACION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected String nivelmaximotramitacion;
            @XmlElement(name = "PROACTIVO", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected String proactivo;
            @XmlElement(name = "CARGASMASIVAS", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected String cargasmasivas;
            @XmlElement(name = "PUBLICACIONSEDE060", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected String publicacionsede060;
            @XmlElement(name = "VOLTRAMITACIONESACTUAL", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected String voltramitacionesactual;
            @XmlElement(name = "VOLTRAMITACIONES", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected EnviaSIA3 .ACTUACIONES.ACTUACION.VOLTRAMITACIONES voltramitaciones;
            @XmlElement(name = "CATALOGACIONES", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected EnviaSIA3 .ACTUACIONES.ACTUACION.CATALOGACIONES catalogaciones;
            @XmlElement(name = "CODESTADOACTUACION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected String codestadoactuacion;
            @XmlElement(name = "DESESTADOACTUACION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            protected String desestadoactuacion;
            @XmlElement(name = "FECHAULTIMAACTUALIZACION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
             ...
             * @return
             *     possible object is
             *     {@link EnviaSIA3 .ACTUACIONES.ACTUACION.TIPOSACTUACION }
             *     
             */
            public EnviaSIA3 .ACTUACIONES.ACTUACION.TIPOSACTUACION getTIPOSACTUACION() {
             ...
             *     
             */
            public void setTIPOSACTUACION(EnviaSIA3 .ACTUACIONES.ACTUACION.TIPOSACTUACION value) {
             ...
             * @return
             *     possible object is
             *     {@link EnviaSIA3 .ACTUACIONES.ACTUACION.ORGANISMORESPONSABLE }
             *     
             */
            public EnviaSIA3 .ACTUACIONES.ACTUACION.ORGANISMORESPONSABLE getORGANISMORESPONSABLE() {
             ...
             *     
             */
            public void setORGANISMORESPONSABLE(EnviaSIA3 .ACTUACIONES.ACTUACION.ORGANISMORESPONSABLE value) {
             ...
             * @return
             *     possible object is
             *     {@link EnviaSIA3 .ACTUACIONES.ACTUACION.AMBITOSGEOGRAFICOS }
             *     
             */
            public EnviaSIA3 .ACTUACIONES.ACTUACION.AMBITOSGEOGRAFICOS getAMBITOSGEOGRAFICOS() {
             ...
             *     
             */
            public void setAMBITOSGEOGRAFICOS(EnviaSIA3 .ACTUACIONES.ACTUACION.AMBITOSGEOGRAFICOS value) {
             ...
             * @return
             *     possible object is
             *     {@link EnviaSIA3 .ACTUACIONES.ACTUACION.AQUIENESVADIRIGIDO }
             *     
             */
            public EnviaSIA3 .ACTUACIONES.ACTUACION.AQUIENESVADIRIGIDO getAQUIENESVADIRIGIDO() {
             ...
             *     
             */
            public void setAQUIENESVADIRIGIDO(EnviaSIA3 .ACTUACIONES.ACTUACION.AQUIENESVADIRIGIDO value) {
             ...
             * @return
             *     possible object is
             *     {@link EnviaSIA3 .ACTUACIONES.ACTUACION.SISTEMASIDENTIFICACION }
             *     
             */
            public EnviaSIA3 .ACTUACIONES.ACTUACION.SISTEMASIDENTIFICACION getSISTEMASIDENTIFICACION() {
             ...
             *     
             */
            public void setSISTEMASIDENTIFICACION(EnviaSIA3 .ACTUACIONES.ACTUACION.SISTEMASIDENTIFICACION value) {
             ...
             * @return
             *     possible object is
             *     {@link EnviaSIA3 .ACTUACIONES.ACTUACION.VOLTRAMITACIONES }
             *     
             */
            public EnviaSIA3 .ACTUACIONES.ACTUACION.VOLTRAMITACIONES getVOLTRAMITACIONES() {
             ...
             *     
             */
            public void setVOLTRAMITACIONES(EnviaSIA3 .ACTUACIONES.ACTUACION.VOLTRAMITACIONES value) {
             ...
             * @return
             *     possible object is
             *     {@link EnviaSIA3 .ACTUACIONES.ACTUACION.CATALOGACIONES }
             *     
             */
            public EnviaSIA3 .ACTUACIONES.ACTUACION.CATALOGACIONES getCATALOGACIONES() {
             ...
             *     
             */
            public void setCATALOGACIONES(EnviaSIA3 .ACTUACIONES.ACTUACION.CATALOGACIONES value) {
            ...
            public static class AMBITOSGEOGRAFICOS {
                ...
                @XmlElement(name = "AMBITOGEOGRAFICO", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                protected List<EnviaSIA3 .ACTUACIONES.ACTUACION.AMBITOSGEOGRAFICOS.AMBITOGEOGRAFICO> ambitogeografico;
                 ...
                 * not a snapshot. Therefore any modification you make to the
                 * returned list will be present inside the JAXB object.
                 * This is why there is not a <CODE>set</CODE> method for the ambitogeografico property.
                 * 
                 * <p>
                 * For example, to add a new item, do as follows:
                 * <pre>
                 ...
                 * 
                 */
                public List<EnviaSIA3 .ACTUACIONES.ACTUACION.AMBITOSGEOGRAFICOS.AMBITOGEOGRAFICO> getAMBITOGEOGRAFICO() {
                    if (ambitogeografico == null) {
                        ambitogeografico = new ArrayList<EnviaSIA3 .ACTUACIONES.ACTUACION.AMBITOSGEOGRAFICOS.AMBITOGEOGRAFICO>();
                    }
                ...
                public static class AMBITOGEOGRAFICO {
                    ...
                    @XmlElement(name = "CODCCAA", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                    protected String codccaa;
                    @XmlElement(name = "DESCCAA", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                    protected String desccaa;
                    @XmlElement(name = "CODPROVINCIA", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                    protected String codprovincia;
                    @XmlElement(name = "DESPROVINCIA", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                    protected String desprovincia;
                    @XmlElement(name = "CODISLA", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                    protected String codisla;
                    @XmlElement(name = "DESISLA", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                    protected String desisla;
                    @XmlElement(name = "CODLOCALIDAD", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                    protected String codlocalidad;
                    @XmlElement(name = "DESLOCALIDAD", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            ...
            public static class AQUIENESVADIRIGIDO {
                ...
                @XmlElement(name = "AQUIENVADIRIGIDO", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                protected List<EnviaSIA3 .ACTUACIONES.ACTUACION.AQUIENESVADIRIGIDO.AQUIENVADIRIGIDO> aquienvadirigido;
                 ...
                 * not a snapshot. Therefore any modification you make to the
                 * returned list will be present inside the JAXB object.
                 * This is why there is not a <CODE>set</CODE> method for the aquienvadirigido property.
                 * 
                 * <p>
                 * For example, to add a new item, do as follows:
                 * <pre>
                 ...
                 * 
                 */
                public List<EnviaSIA3 .ACTUACIONES.ACTUACION.AQUIENESVADIRIGIDO.AQUIENVADIRIGIDO> getAQUIENVADIRIGIDO() {
                    if (aquienvadirigido == null) {
                        aquienvadirigido = new ArrayList<EnviaSIA3 .ACTUACIONES.ACTUACION.AQUIENESVADIRIGIDO.AQUIENVADIRIGIDO>();
                    }
                ...
                public static class AQUIENVADIRIGIDO {
                    ...
                    @XmlElement(name = "CODAQUIENVADIRIGIDO", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                    protected String codaquienvadirigido;
                    @XmlElement(name = "DESAQUIENVADIRIGIDO", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            ...
            public static class CATALOGACIONES {
                ...
                @XmlElement(name = "CATALOGACION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                protected List<EnviaSIA3 .ACTUACIONES.ACTUACION.CATALOGACIONES.CATALOGACION> catalogacion;
                 ...
                 * not a snapshot. Therefore any modification you make to the
                 * returned list will be present inside the JAXB object.
                 * This is why there is not a <CODE>set</CODE> method for the catalogacion property.
                 * 
                 * <p>
                 * For example, to add a new item, do as follows:
                 * <pre>
                 ...
                 * <p>
                 * Objects of the following type(s) are allowed in the list
                 * {@link EnviaSIA3 .ACTUACIONES.ACTUACION.CATALOGACIONES.CATALOGACION }
                 * 
                 * 
                 */
                public List<EnviaSIA3 .ACTUACIONES.ACTUACION.CATALOGACIONES.CATALOGACION> getCATALOGACION() {
                    if (catalogacion == null) {
                        catalogacion = new ArrayList<EnviaSIA3 .ACTUACIONES.ACTUACION.CATALOGACIONES.CATALOGACION>();
                    }
                ...
                public static class CATALOGACION {
                    ...
                    @XmlElement(name = "CODCATALOGACION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                    protected String codcatalogacion;
                    @XmlElement(name = "DESCATALOGACION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            ...
            @XmlType(name = "", propOrder = {
                ...
                "desorganismoresponsablen1",
                "codorganismoresponsablen2",
                "desorganismoresponsablen2"
            })
            public static class ORGANISMORESPONSABLE {

                @XmlElement(name = "CODCLASETERRITORIAL", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                protected String codclaseterritorial;
                @XmlElement(name = "DESCLASETERRITORIAL", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                protected String desclaseterritorial;
                @XmlElement(name = "CODCOMUNIDADAUTONOMA", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                protected String codcomunidadautonoma;
                @XmlElement(name = "DESCOMUNIDADAUTONOMA", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                protected String descomunidadautonoma;
                @XmlElement(name = "CODAMBITO", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                protected String codambito;
                @XmlElement(name = "DESAMBITO", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                protected String desambito;
                @XmlElement(name = "CODTIPOENTIDAD", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                protected String codtipoentidad;
                @XmlElement(name = "DESTIPOENTIDAD", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                protected String destipoentidad;
                @XmlElement(name = "CODORGANISMORESPONSABLEN1", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                protected String codorganismoresponsablen1;
                @XmlElement(name = "DESORGANISMORESPONSABLEN1", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                protected String desorganismoresponsablen1;
                @XmlElement(name = "CODORGANISMORESPONSABLEN2", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                protected String codorganismoresponsablen2;
                @XmlElement(name = "DESORGANISMORESPONSABLEN2", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            ...
            public static class SISTEMASIDENTIFICACION {
                ...
                @XmlElement(name = "SISTEMAIDENTIFICACION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                protected List<EnviaSIA3 .ACTUACIONES.ACTUACION.SISTEMASIDENTIFICACION.SISTEMAIDENTIFICACION> sistemaidentificacion;
                 ...
                 * 
                 */
                public List<EnviaSIA3 .ACTUACIONES.ACTUACION.SISTEMASIDENTIFICACION.SISTEMAIDENTIFICACION> getSISTEMAIDENTIFICACION() {
                    if (sistemaidentificacion == null) {
                        sistemaidentificacion = new ArrayList<EnviaSIA3 .ACTUACIONES.ACTUACION.SISTEMASIDENTIFICACION.SISTEMAIDENTIFICACION>();
                    }
                ...
                @XmlType(name = "", propOrder = {
                    ...
                    "dessistemaidentificacion",
                    "otrosistemaidentificacion"
                })
                public static class SISTEMAIDENTIFICACION {

                    @XmlElement(name = "CODSISTEMAIDENTIFICACION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                    protected String codsistemaidentificacion;
                    @XmlElement(name = "DESSISTEMAIDENTIFICACION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                    protected String dessistemaidentificacion;
                    @XmlElement(name = "OTROSISTEMAIDENTIFICACION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            ...
            public static class TIPOSACTUACION {
                ...
                @XmlElement(name = "TIPOACTUACION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA", required = true)
                protected List<EnviaSIA3 .ACTUACIONES.ACTUACION.TIPOSACTUACION.TIPOACTUACION> tipoactuacion;
                 ...
                 * not a snapshot. Therefore any modification you make to the
                 * returned list will be present inside the JAXB object.
                 * This is why there is not a <CODE>set</CODE> method for the tipoactuacion property.
                 * 
                 * <p>
                 * For example, to add a new item, do as follows:
                 * <pre>
                 ...
                 * <p>
                 * Objects of the following type(s) are allowed in the list
                 * {@link EnviaSIA3 .ACTUACIONES.ACTUACION.TIPOSACTUACION.TIPOACTUACION }
                 * 
                 * 
                 */
                public List<EnviaSIA3 .ACTUACIONES.ACTUACION.TIPOSACTUACION.TIPOACTUACION> getTIPOACTUACION() {
                    if (tipoactuacion == null) {
                        tipoactuacion = new ArrayList<EnviaSIA3 .ACTUACIONES.ACTUACION.TIPOSACTUACION.TIPOACTUACION>();
                    }
                ...
                public static class TIPOACTUACION {
                    ...
                    @XmlElement(name = "CODTIPOACTUACION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                    protected String codtipoactuacion;
                    @XmlElement(name = "DESTIPOACTUACION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
            ...
            public static class VOLTRAMITACIONES {
                ...
                @XmlElement(name = "VOLTRAMITACION", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                protected List<EnviaSIA3 .ACTUACIONES.ACTUACION.VOLTRAMITACIONES.VOLTRAMITACION> voltramitacion;
                 ...
                 * not a snapshot. Therefore any modification you make to the
                 * returned list will be present inside the JAXB object.
                 * This is why there is not a <CODE>set</CODE> method for the voltramitacion property.
                 * 
                 * <p>
                 * For example, to add a new item, do as follows:
                 * <pre>
                 ...
                 * <p>
                 * Objects of the following type(s) are allowed in the list
                 * {@link EnviaSIA3 .ACTUACIONES.ACTUACION.VOLTRAMITACIONES.VOLTRAMITACION }
                 * 
                 * 
                 */
                public List<EnviaSIA3 .ACTUACIONES.ACTUACION.VOLTRAMITACIONES.VOLTRAMITACION> getVOLTRAMITACION() {
                    if (voltramitacion == null) {
                        voltramitacion = new ArrayList<EnviaSIA3 .ACTUACIONES.ACTUACION.VOLTRAMITACIONES.VOLTRAMITACION>();
                    }
                ...
                public static class VOLTRAMITACION {
                    ...
                    @XmlElement(name = "ANIO", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                    protected String anio;
                    @XmlElement(name = "PERIODO", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                    protected String periodo;
                    @XmlElement(name = "VOLTOTAL", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                    protected String voltotal;
                    @XmlElement(name = "VOLELE", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                    protected String volele;
                    @XmlElement(name = "VOLNOELE", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                    protected String volnoele;
                    @XmlElement(name = "VOLCERTIFICADOELE", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                    protected String volcertificadoele;
                    @XmlElement(name = "VOLDNIELE", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
                    protected String voldniele;
                    @XmlElement(name = "VOLELEOTRO", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA")
    ...
    public static class ERROR {
        ...
        @XmlElement(name = "DESCERROR", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA", required = true)
        protected String descerror;
        @XmlElement(name = "ERROR", namespace = "http://www.map.es/sgca/consultar/messages/EnviaSIA", required = true)
