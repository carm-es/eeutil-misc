...
/**
 * <p>Clase Java para PERFILES complex type.
 * 
...
@XmlType(name = "PERFILES", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA", propOrder = {
    "perfil"
})
public class PERFILES {
    ...
    public static class PERFIL {
        ...
        @XmlElement(name = "CODTIPOPERFIL", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String codtipoperfil;
        @XmlElement(name = "DESTIPOPERFIL", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
