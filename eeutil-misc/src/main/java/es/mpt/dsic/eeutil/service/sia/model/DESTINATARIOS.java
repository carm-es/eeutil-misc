...
@XmlType(name = "DESTINATARIOS", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA", propOrder = {
    "destinatario"
})
public class DESTINATARIOS {
    ...
    public static class DESTINATARIO {
        ...
        @XmlElement(name = "CODDESTINATARIO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA", required = true)
        protected String coddestinatario;
        @XmlElement(name = "DESDESTINATARIO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA", required = true)
