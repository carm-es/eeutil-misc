...
@XmlType(name = "INICIOS", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA", propOrder = {
    "inicio"
})
public class INICIOS {
    ...
    public static class INICIO {
        ...
        @XmlElement(name = "CODFORMAINICIACION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String codformainiciacion;
        @XmlElement(name = "DESFORMAINICIACION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String desformainiciacion;
        @XmlElement(name = "CODEFECTOSILENCIO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String codefectosilencio;
        @XmlElement(name = "DESEFECTOSILENCIO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
