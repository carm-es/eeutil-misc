...
@XmlRootElement(name = "paramSIA", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/ParamSIA")
public class ParamSIA2 {
    ...
    @XmlElement(namespace = "http://www.map.es/sgca/consultar/messages/v2_4/ParamSIA", required = true)
    ...
    public static class Filtro {
         ...
         * @return
         *     possible object is
         *     {@link ParamSIA2 .Filtro.FechasModificacion }
         *     
         */
         ...
         * @return
         *     possible object is
         *     {@link ParamSIA2 .Filtro.Organismo }
         *     
         */
