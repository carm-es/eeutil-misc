...
@XmlType(name = "DOCUMENTOSCATALOGO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA", propOrder = {
    "documentocatalogo"
})
public class DOCUMENTOSCATALOGO {
    ...
    public static class DOCUMENTOCATALOGO {
        ...
        @XmlElement(name = "CODDOCUMENTO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String coddocumento;
        @XmlElement(name = "DESDOCUMENTO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String desdocumento;
        @XmlElement(name = "CATALOGOCOMUN", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String catalogocomun;
        @XmlElement(name = "CODENTIDADEMISORA", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String codentidademisora;
        @XmlElement(name = "CODORGARESPN1", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String codorgarespn1;
        @XmlElement(name = "CODORGARESPN2", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String codorgarespn2;
        @XmlElement(name = "CODORGAEMISORN1", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String codorgaemisorn1;
        @XmlElement(name = "CODORGAEMISORN2", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String codorgaemisorn2;
        @XmlElement(name = "OBLIGADOAPORTARLOINTERESADO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA", required = true)
