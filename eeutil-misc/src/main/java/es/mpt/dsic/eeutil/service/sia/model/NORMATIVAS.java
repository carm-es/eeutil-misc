...
@XmlType(name = "NORMATIVAS", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA", propOrder = {
    "normativa"
})
public class NORMATIVAS {
    ...
    public static class NORMATIVA {
        ...
        @XmlElement(name = "CODTIPONORMATIVA", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String codtiponormativa;
        @XmlElement(name = "DESTIPONORMATIVA", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String destiponormativa;
        @XmlElement(name = "CODRANGO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String codrango;
        @XmlElement(name = "DESRANGO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String desrango;
        @XmlElement(name = "NUMERODISPOSICION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String numerodisposicion;
        @XmlElement(name = "TITULO", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
