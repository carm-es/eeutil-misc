...
@XmlType(name = "SISTEMASIDENTIFICACION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA", propOrder = {
...
public class SISTEMASIDENTIFICACION {
    ...
    public static class SISTEMAIDENTIFICACION {
        ...
        @XmlElement(name = "CODSISTEMAIDENTIFICACION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String codsistemaidentificacion;
        @XmlElement(name = "DESSISTEMAIDENTIFICACION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String dessistemaidentificacion;
        @XmlElement(name = "OTROSISTEMAIDENTIFICACION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
