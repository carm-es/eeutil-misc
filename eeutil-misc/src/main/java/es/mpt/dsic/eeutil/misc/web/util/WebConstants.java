...
public class WebConstants {
	...
	public static final String VERSION_NTI = "http://administracionelectronica.gob.es/ENI/XSD/v1.0/expediente-e";
	...
	public static final String MSG_KEY_DOC_VISUALIZAR_NOMBRE_DOCENI = "visualizarDocumento.nombre.doceni";
	...
	public static final String MSG_ERROR_VALIDACION_EXPE_SIN_FIRMA = "Validación incorrecta : cvc-complex-type.2.4.b: The content of element 'eniconexpind:CarpetaIndizada' is not complete";
	public static final String MSG_ERROR_VALIDACION_EXPE_SIN_FIRMA_ADITIONAL = "Validación incorrecta : cvc-complex-type.2.4.b: The content of element 'ns2:indice' is not complete";
	...
	public static final String MSG_IMPORTAR_EXP_EXP_NO_VALIDO = "importarExpediente.error.expNoValido";
	public static final String MSG_IMPORTAR_EXP_CORRESP_NO_VALIDA = "importarExpediente.error.correspNoValida";
	public static final String MSG_IMPORTAR_EXP_OK = "importarExpediente.ok";
	
	//importar expediente
	public static final String MSG_IMPORTAR_DOC_EXP_NO_ENCONTRADO = "importarDocumento.error.expNoEncontrado";
	public static final String MSG_IMPORTAR_DOC_NO_VALIDO = "importarDocumento.error.docNoValido";
	public static final String MSG_IMPORTAR_DOC_USUARIO_NO_ASOCIADO_EXP = "importarDocumento.error.docUsuarioNoAsociadoExp";
	public static final String MSG_IMPORTAR_DOC_USUARIO_NO_ASOCIADO_DOC = "importarDocumento.error.docUsuarioNoAsociadoDoc";
	...
	public static final String MSG_BAJA_DOC_VINCULADO = "documentosAlmacenados.bajdoc.vinculado.error";
	...
	public static final String MSG_EXP_ALMACENADOS_GENERATE_TOKEN = "expedientesAlmacenados.generarToken.error";
	public static final String MSG_BAJA_EXP_OK = "expedientesAlmacenados.bajexp.ok";
	
	public static final String MSG_EXP_PUESTADISPOSICION_NO_VALIDO = "puestaDisposicion.token.novalido";
