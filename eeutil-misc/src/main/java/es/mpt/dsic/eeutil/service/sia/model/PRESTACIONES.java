...
@XmlType(name = "PRESTACIONES", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA", propOrder = {
    "prestacion"
})
public class PRESTACIONES {
    ...
    public static class PRESTACION {
        ...
        @XmlElement(name = "CODTIPOPRESTACION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
        protected String codtipoprestacion;
        @XmlElement(name = "DESTIPOPRESTACION", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA")
