...
/**
 * <p>
 * Clase Java para PRESTACIONES complex type.
 * 
 * <p>
...
public class PRESTACIONES {
   ...
   * there is not a <CODE>set</CODE> method for the prestacion property.
   * 
   * <p>
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link PRESTACIONES.PRESTACION }
   * 
   * 
   */
   ...
   */
  @XmlAccessorType(XmlAccessType.FIELD)
  @XmlType(name = "", propOrder = {"codtipoprestacion", "destipoprestacion", "otro"})
