...
public interface EeUtilService {
	...
	public ContenidoInfo convertirTCNAPdf (@WebParam(name = "aplicacionInfo")  @XmlElement(required=true,name="aplicacionInfo") ApplicationLogin info,
	...
	public SalidaVisualizacion  visualizarFacturae(@WebParam(name = "aplicacionInfo")  @XmlElement(required=true,name="aplicacionInfo")ApplicationLogin info,	
	...
	public Boolean comprobarPDFA(@WebParam(name = "aplicacionInfo")  @XmlElement(required=true,name="aplicacionInfo")ApplicationLogin info,	
			@WebParam(name = "DocumentoEntrada")  @XmlElement(required=true,name="DocumentoEntrada")DocumentoEntrada docEntrada, @XmlElement(required=false,name="nivelCompilacion")Integer nivelCompilacion)  throws InSideException;
	
	@WebMethod(operationName = "convertirPDFA", action = "urn:convertirPDFA")
	@WebResult(name = "PdfSalida", partName = "PdfSalida")
	public PdfSalida convertirPDFA(@WebParam(name = "aplicacionInfo")  @XmlElement(required=true,name="aplicacionInfo")ApplicationLogin info,	
			@WebParam(name = "DocumentoEntrada")  @XmlElement(required=true,name="DocumentoEntrada")DocumentoEntrada docEntrada, @XmlElement(required=false,name="nivelCompilacion")Integer nivelCompilacion)  throws InSideException;
	...
	@WebResult(name = "FacturaProcesada", partName = "FacturaProcesada")
	public SalidaVisualizacion  visualizarFacturaePDF(@WebParam(name = "aplicacionInfo")  @XmlElement(required=true,name="aplicacionInfo")ApplicationLogin info,	
			@WebParam(name = "Factura")  @XmlElement(required=true,name="Factura")byte[] factura, @XmlElement(required=false,name="Version")String version)  throws InSideException;
