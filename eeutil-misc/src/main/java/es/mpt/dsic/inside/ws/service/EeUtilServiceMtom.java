...
public interface EeUtilServiceMtom {
	...
	public Boolean comprobarPDFA(@WebParam(name = "aplicacionInfo")  @XmlElement(required=true,name="aplicacionInfo")ApplicationLogin info,	
			@WebParam(name = "DocumentoEntradaMtom")  @XmlElement(required=true,name="DocumentoEntradaMtom")DocumentoEntradaMtom docEntrada, @XmlElement(required=false,name="nivelCompilacion")Integer nivelCompilacion)  throws InSideException;
	
	@WebMethod(operationName = "convertirPDFA", action = "urn:convertirPDFA")
	@WebResult(name = "PdfSalidaMtom", partName = "PdfSalidaMtom")
	public PdfSalidaMtom convertirPDFA(@WebParam(name = "aplicacionInfo")  @XmlElement(required=true,name="aplicacionInfo")ApplicationLogin info,	
			@WebParam(name = "DocumentoEntradaMtom")  @XmlElement(required=true,name="DocumentoEntradaMtom")DocumentoEntradaMtom docEntrada, @XmlElement(required=false,name="nivelCompilacion")Integer nivelCompilacion)  throws InSideException;
