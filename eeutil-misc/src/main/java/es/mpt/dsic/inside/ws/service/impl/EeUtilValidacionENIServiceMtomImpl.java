...
public class EeUtilValidacionENIServiceMtomImpl implements EeUtilValidacionENIServiceMtom {
	...
	@Override
	public RespuestaValidacionENI validarDocumentoENI(ApplicationLogin info, DocumentoEntradaMtom documentoENI, String version, Validaciones validaciones){		
	...
	@Override
	public RespuestaValidacionENI validarExpedienteENI(ApplicationLogin info, DocumentoEntradaMtom expedienteENI, String version, Validaciones validaciones){		
		...
		try
		{
			expedienteRecibidoOriginalSinTocar = IOUtils.toByteArray(expedienteENI.getContenido().getInputStream());
			dataExpedienteENIXml = XMLUtil.obtenerExpedienteENIXML(XMLUtil.decodeUTF8(expedienteRecibidoOriginalSinTocar));
			dataExpedienteENIXmlNoProcedenteInside = XMLUtil.obtenerExpedienteENIXMLNoProcedenteInside(XMLUtil.decodeUTF8(expedienteRecibidoOriginalSinTocar));
		...
		if(validaciones.isValidaFirma())
		{
			...
			Detalle detalleFirma  = eeutilEniValidationENIService.validarFirmaExpedienteEniFile(info, dataExpedienteENIXml,dataExpedienteENIXmlNoProcedenteInside, expedienteRecibidoOriginalSinTocar);	
			listaDetalles.add(detalleFirma);
		}
	...
	@Override
	public RespuestaValidacionENI validarFirmaExpedienteENI(ApplicationLogin info, DocumentoEntradaMtom expedienteENI) {
	...
	@Override
	public RespuestaValidacionENI validarFirmaDocumentoENI(ApplicationLogin info, DocumentoEntradaMtom documentoENI)  {
		//Lista resultado de las validaciones
		List<Detalle> listaDetalles = new ArrayList<Detalle>();
	...
	@Override
	public RespuestaValidacionENI validarExpedienteDocumentosENIZIP(ApplicationLogin info, DocumentoEntradaMtom docZipEntrada,String version,
	...
	private RespuestaValidacionENI correspondenciaIdentificadoresDocIndiceConDocumentos(List<String> indice, List<String> documentos)
	{
		...
		if(indice.size() != documentos.size())
		{
	    	...
	    	detalleValidacion.setCodigoRespuesta(ExpedienteENICodigosRespuestaValidacion.E_N_999_CODIGO);
	    	detalleValidacion.setDetalleRespuesta(ExpedienteENICodigosRespuestaValidacion.E_N_999_DETALLE+ "-- Documentos no en Indice :"+documentoNoEnIndice.toString());
	    	listaDetalles.add(detalleValidacion);
		}
