...
public interface EeutilEniValidationENIService {
	...
	Detalle validarFirmaDocumentoEniFile(ApplicationLogin info, String xml);
	...
	Detalle validarFirmaExpedienteEniFile(ApplicationLogin info, String xml, String xmlNoProcedenteInside, byte[] expedienteRecibidoOriginalSinTocar);
