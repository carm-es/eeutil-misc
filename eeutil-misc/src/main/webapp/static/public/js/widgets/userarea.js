$mf.TopBar = function($el){
    if(typeof($mf.my_dialog) == 'undefined') $mf.my_dialog = new $mf.Dialog($("div.mf-dialog").empty());
    var mostrar_todos = function(ind, el){
        ...
        init = function($el){
            ...
            $selectProfile.each(function(i,a){
                ...
                $(a).text(profileText.length > 25 ? profileText.substr(0,10)+'... ...'+profileText.substr(profileText.length-10,10) : profileText);
            });
        };
