...
function docWriteWrapper(func) {
    var writeTo = document.createElement('del'), oldwrite = document.write, content = '';
    writeTo.id = "me";
...
function firmaPeticion(datosPeticion, validar) {
    ...
    var firmas = "{'signatureToken': '" + $("#signatureToken").val() + "', 'validarFirma': '" + validar
            + "', 'state': 'success', 'requestTagId': '" + datosPeticion.requestTagId + "', 'signatures': [";
