...
/**
 * The goal of this subclass is to allow any unknown requested attribute to be generated by the
 * ServiceProvider.
 */
public final class SpEidasProtocolProcessor extends EidasProtocolProcessorNoMetadata
  ...
  public SpEidasProtocolProcessor(/* @Nonnull */String eidasAttributesFileName,
      /* @Nonnull */String additionalAttributesFileName, /* @Nullable */String defaultPath) {
  ...
  public AttributeDefinition<?> getAttributeDefinitionNullable(/* @Nonnull */String name) {
    ...
    AttributeDefinition<String> unknownAttribute = AttributeDefinition.<String>builder()
        .nameUri(name).friendlyName(PersonalAttribute.extractFriendlyName(name))
