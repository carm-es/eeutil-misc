...
/**
 * <p>
 * Clase Java para REDUCCIONES complex type.
 * 
 * <p>
...
@XmlType(name = "REDUCCIONES", propOrder = {"reduccion"})
public class REDUCCIONES2 {

  @XmlElement(name = "REDUCCION")
  protected List<REDUCCIONES2.REDUCCION> reduccion;
   ...
   * there is not a <CODE>set</CODE> method for the reduccion property.
   * 
   * <p>
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link REDUCCIONES2 .REDUCCION }
   * 
   * 
   */
  public List<REDUCCIONES2.REDUCCION> getREDUCCION() {
    if (reduccion == null) {
      reduccion = new ArrayList<REDUCCIONES2.REDUCCION>();
    }
   ...
   */
  @XmlAccessorType(XmlAccessType.FIELD)
  @XmlType(name = "", propOrder = {"codtiporeduccion", "destiporeduccion"})
