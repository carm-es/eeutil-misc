...
public class DESTINATARIOS {
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link DESTINATARIOS.DESTINATARIO }
   * 
   * 
   */
