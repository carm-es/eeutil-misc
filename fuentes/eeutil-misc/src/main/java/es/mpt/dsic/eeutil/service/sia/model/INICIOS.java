...
@XmlType(name = "INICIOS", namespace = "http://www.map.es/sgca/consultar/messages/v2_4/EnviaSIA",
    propOrder = {"inicio"})
public class INICIOS {
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link INICIOS.INICIO }
   * 
   * 
   */
