...
/**
 * <p>
 * Clase Java para DESTINATARIOS complex type.
 * 
 * <p>
...
@XmlType(name = "DESTINATARIOS", propOrder = {"destinatario"})
public class DESTINATARIOS2 {

  @XmlElement(name = "DESTINATARIO")
  protected List<DESTINATARIOS2.DESTINATARIO> destinatario;
   ...
   * there is not a <CODE>set</CODE> method for the destinatario property.
   * 
   * <p>
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link DESTINATARIOS2 .DESTINATARIO }
   * 
   * 
   */
  public List<DESTINATARIOS2.DESTINATARIO> getDESTINATARIO() {
    if (destinatario == null) {
      destinatario = new ArrayList<DESTINATARIOS2.DESTINATARIO>();
    }
   ...
   */
  @XmlAccessorType(XmlAccessType.FIELD)
  @XmlType(name = "", propOrder = {"coddestinatario", "desdestinatario"})
