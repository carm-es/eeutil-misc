...
/**
 * <p>
 * Clase Java para ampliarFirma complex type.
 * 
 * <p>
 * El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ampliarFirma">
 *   &lt;complexContent>
 ...
 *         &lt;element name="configuracionAmpliarFirma" type="{http://service.ws.inside.dsic.mpt.es/}configuracionAmpliarFirma"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ampliarFirma",
    propOrder = {"aplicacionInfo", "firma", "configuracionAmpliarFirma"})
public class AmpliarFirma {
  ...
  @XmlElement(required = true)
  protected ConfiguracionAmpliarFirma configuracionAmpliarFirma;
  ...
  /**
   * Obtiene el valor de la propiedad configuracionAmpliarFirma.
   * 
   * @return possible object is {@link ConfiguracionAmpliarFirma }
   * 
   */
  public ConfiguracionAmpliarFirma getConfiguracionAmpliarFirma() {
    return configuracionAmpliarFirma;
  }

  /**
   * Define el valor de la propiedad configuracionAmpliarFirma.
   * 
   * @param value allowed object is {@link ConfiguracionAmpliarFirma }
   * 
   */
  public void setConfiguracionAmpliarFirma(ConfiguracionAmpliarFirma value) {
    this.configuracionAmpliarFirma = value;
  }
